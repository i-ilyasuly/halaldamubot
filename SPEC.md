...
- Берілген координаттан жақын халал мекемелерді табады
- Пагинация қолдайды
...
| 2026-03-20 | Тілдік қателіктер түзетілді: статус орысшаға аударылды; тариф белгілері label_ru қосылды | `formatters.py`, `tariffs.py`, `handlers_callback.py` |
